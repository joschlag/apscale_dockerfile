# This script is part of the APSCALE 4.1.4 pipeline by Dominik Buchner 
# https://github.com/DominikBuchner/apscale.git

# It was modified to write csv files instead of xlsx
...
def generate_read_table(
    ...
    if sequence_count > 1_000_000:
        ...
        for idx, chunk in sample_names_iter:
            ...
            output_file_name_csv = output_file_name_xlsx.with_suffix(".csv")
            read_table.to_csv(output_file_name_csv, index=False)
...
def write_log(logfile_base_path: str, database_path: str):
    ...
    while True:
        ...
        logfile_name_csv = logfile_name.with_suffix(".csv")
        chunk.to_csv(logfile_name_csv, index=False)
